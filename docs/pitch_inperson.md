...
> "Elastane is in about 80% of all clothing, and as little as 1% of it makes a textile recycler reject the entire garment. That is why your kid's worn-out onesie becomes pet bedding instead of another onesie.
>
> Everyone trying to fix this designs an enzyme to attack the elastane that already exists, a crystalline fiber that defeats every natural enzyme. We inverted it. We co-designed a new cleavable elastane AND the matched enzyme that uniquely cleaves it. Two coupled molecules, neither with any prior art."
...
- **Beat 4, Engine B, the shouldn't-be-possible moment (25s)** [Mol* live]: "This is a de novo enzyme, designed de novo, rotating live in the browser. RFdiffusion built the backbone, LigandMPNN the sequence, Boltz-2 the structure, PLACER scored the active-site geometry. This is the Ser-His-Asp triad, engineered near-neutral pH so it does not damage the cotton. FoldSeek finds no close match in the entire protein databank, a genuinely new fold. No de novo carbamate hydrolase has ever been publicly disclosed. Download the PDB and check it."
- **Beat 5, the close (20s)** [Loop]: "Here is the loop closing. The bond cleaves, the fiber depolymerizes into recoverable monomers, re-spun into a new onesie, the two colors fuse at the cleavage. Carter's already pays TerraCycle for that downcycling line item. Same line item, better outcome: a fiber-to-fiber loop plus an SB 707 compliance asset. We're the Nexus Circular of textiles."
